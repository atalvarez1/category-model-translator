"""
OpenAI/ChatGPT Translation Integration

Uses OpenAI API for context-aware translation of call center QA phrases.
"""
...
class OpenAITranslator:
    """OpenAI API integration for intelligent translation."""
...
- Return ONLY the JSON object with translations - no markdown, no explanation"""
    ...
    def translate_batch(self, phrases: List[str], target_lang: str,
        ...
        """
        Translate a batch of phrases using OpenAI.
        """
        if not phrases:
        ...
        try:
            response = requests.post(
                ...
                json={
                    ...
                    'max_tokens': 8192,
                    'messages': [
                        {'role': 'system', 'content': self._build_system_prompt(target_lang, category_context)},
